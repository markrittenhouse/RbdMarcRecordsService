...
namespace MarcRecordServiceSite.Infrastructure
{
    public class MarcRecordService
    {
        ...
        public string WriteIndividualMarcFile(MarcRecordFile marcRecordFile, JsonIsbnAndCustomerField jsonIsbnAndCustomerField, string accountNumber, out string lastIsbn, JsonIsbnAndCustomerField commonJsonFields = null)
        {
            ...
            _log.DebugFormat("Id: {0} | FileData: {1}", marcRecordFile.Id, marcRecordFile.FileData);
        ...
        public List<MarcRecordFile> CreateDeleteMarcRecordFiles(List<MarcRecordFile> files)
        {
        ...
        private void PopulateUrlInMarcRecord(string filePath, bool isR2Library, MarcRecordFile marcRecordFile)
        {
